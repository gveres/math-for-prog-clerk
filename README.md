...
> **Note**
> This project was generated by the [`mafs/clerk`
> template](https://github.com/mentat-collective/Mafs.cljs/tree/main/resources/mafs/clerk)
> from [`Mafs.cljs`](https://mafs.mentat.org).

This project allows you to interactively develop [Clerk][clerk-url] notebooks
using [`Mafs.cljs`](https://mafs.mentat.org) code inside of your project's
[viewers](https://book.clerk.vision#viewers), and produce static builds of these
notebooks ready for publication via [GitHub Pages](https://pages.github.com/) or
[Clerk's Garden](https://clerk.garden/).
...
```clj
(clerk/show! "notebooks/indolamine/math_for_prog.clj")
```
...
All ClojureScript code you add to `src/indolamine/custom.cljs` is available
for use inside any [custom viewer code you
write](https://book.clerk.vision/#writing-viewers).

This is made possible by the code in `src/indolamine/sci_viewers.cljs`. If you
...
- [Create a GitHub repository](https://github.com/new). Ideally the owner
  matches `indolamine` and the project name is `math-for-prog`.
...
git branch -M main
git remote add origin git@github.com:indolamine/math-for-prog.git
git push -u origin main
```

Then visit https://github.com/indolamine/math-for-prog to see your site.
...
By default your site will live at https://indolamine.github.io/math-for-prog.
...
https://github.clerk.garden/indolamine/math-for-prog
